...
<body>
	<div id="header"></div>
	<div class="main">
		<h1 class="h2 mb-3 fw-normal fw-bold">회원정보 수정</h1>
		
		<br>
		<form modelAttribute="memberCommand" action="/book/mypage/member/update.do"
			method="post">
			<div>
				아이디(이메일)<span style="color: red;">*</span>
			</div>
			<input type="text" name="email" class="form-control"
				placeholder="예시) abc.@naver.com" value="${member.email}"readonly/>
			<br>
			...
			<span class="seperate_space" style="margin-right: 9%;">
				...
				</div> <input type="text" name="name" class="form-control"value="${member.name}" /> 
			</span>

			<span class="seperate_space">
				<div>
					닉네임 <span style="color: red;">*</span>
				</div> <input type="text" name="nickname" class="form-control" value="${member.nickname}" />
			</span>
			<br>
			<br>
			...
			<span class="seperate_space" style="width: 60%; margin-right: 5%;">
				...
				</div> <input type="text"name="phone" class="form-control"
					placeholder="예시) 010-1111-1111" style="width=70%;" value="${member.phone}"/> 
			</span>
			...
			<select name="address1" id="address1" class="form-select" selected="${member.address1}"></select>
			<select type="select"  name="address2" id="address2" class="form-select"selected="${member.address1}"></select>

			<br>
			<br>

			<div>관심 있는 장르를 선택해 주세요.</div>
			<div class="row">
